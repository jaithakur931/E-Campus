...
<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        {
        mysqli_query($db_conn, "INSERT INTO useraccounts (`name`,`email`,`password`,`type`) VALUE ('$name','$email','$password','$type')") or die(mysqli_error($db_conn));
...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <div class="d-flex">
                <h1 class="m-0 ">Add Accounts</h1>
                <a href="add-account.php?user=<?=$_REQUEST['user']?>&action=add-new" class="btn btn-primary">Add New</a>
                </div>
            </div>
            <div class="col-sm-6">
        ...
        <?php if(isset($_GET['action'])&& $_GET['action']) { ?>
            <div class="card">
                ...
                <form action="" id="student-registration" method="POST">
                    ...
                    <fieldset class="border border-primary p-3 form-group">
                        <legend class="d-line w-auto h6">Student Information</legend>
                        <div class="row">
                            <div class="col-lg-12">
                    ...
                    <fieldset class="border border-primary p-3 form-group">
                        <legend class="d-line w-auto h6">Parent Information</legend>
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Mother Mobile" name="mother_mobile">
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label for="">Address</label>
                                    <input type="text" class="form-control" placeholder="Parent Address" name="parents_address">
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                    ...
                    <fieldset class="border border-primary p-3 form-group">
                        <legend class="d-line w-auto h6">Last Qualification</legend>
                        <div class="row">
                            ...
                            <div class="col-lg">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Obtain Marks" name="obtain_marks">
                                </div>
                            </div>
                            <div class="col-lg">
                                <div class="form-group">
                    ...
                    <fieldset class="border border-primary p-3 form-group">
                        <legend class="d-line w-auto h6">Admission Details</legend>
                        <div class="row">
                            <div class="col-lg">
                                <div class="form-group">
                                    <label for="">Class</label>
                            ...
                            <div class="col-lg">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Subject Stream" name="subject_stream">
                                </div>
                            </div>
                            <div class="col-lg">
                                <div class="form-group">
        ...
        <div class="table-responsive">
            <table class="table table-bordered">
                ...
                <tbody>
                        <?php
                        $count = 1;
            $user_query = 'SELECT*FROM useraccounts WHERE `type`="'.$_REQUEST['user'].'"';
...
<script>
    ...
    jQuery('#student-registration').on('submit',function(){
        ...
        if(true)
        {
            ...
            jQuery.ajax({
                type: "post",
                url : "http://localhost/minoreproject/actions/student-registration.php",
                data : formdata ,
                beforeSend : function () {
                   jQuery('#loader').show();
                },
