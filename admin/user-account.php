...
<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        {
        mysqli_query($db_conn, "INSERT INTO accounts (`name`,`email`,`password`,`type`) VALUE ('$name','$email','$password','$type')") or die(mysqli_error($db_conn));
    ...
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                ...
                <a href="user-account.php?user=<?=$_REQUEST['user']?>&action=add-new" class="btn btn-primary">Add New</a>
                </div>
            </div>
            <div class="col-sm-6">
