...
<div class="d-flex " style="">
    ...
    <h1 class="display-8 font-bold text-LEFT ">PHARMACY</h1><br><h2 class="text-LEFT">Admission To B.E Courses</h2>
    <hr>
    <h4>->Eligibility criteria for admission in B.Pharma. Student must be 12th pass with PCM or PCB. Available Seats are 100.Other than scholarships sanctioned by Adim Jati Kalyan vibhag we also provide Merit scholarship schemes for meritorious students of general and other category students.
    <br>
    <br>
    ->Eligibility criteria for admission in M.Pharma.
    <br>
    <br>
    ->Students cleared in GPAT Examination
    <br>
    <br>
    50% marks in B.Pharmacy(45% SC/ST/OBC).
...
<table class="table table-bordered " >
  ...
  <tbody>
    <tr>
      <th scope="row">1</th>
      <td class="text-center">B.Pharm</td>
      <td>120</td>
      <td>4 YEARS</td>
    ...
    <tr>
      <th scope="row">2</th>
      <td class="text-center">M.Pharm</td>
      <td>18</td>
      <td>2 YEARS</td>
    ...
    <tr>
      <th scope="row">3</th>
      <td class="text-center">Pharmaceutical Chemistry</td>
      <td>18</td>
      <td>2 YEARS</td>
    </tr>
    <tr>
      <th scope="row">4</th>
      <td class="text-center">Pharmacology</td>
      <td>18</td>
      <td>2 YEARS</td>
    </tr>
  </tbody>
...
<div class="container-fluid ">
    ...
    <h4 class="text-left text-bold"><b>Bachelor Of Pharmacy (B.Pharm)</b></h4>
    <hr>
    ...
    <ol>
        ...
        <li>Educational Qualifications
            <ul>
            <li>The Candidate Should have passed 12th class exam with Physics and Chemistry as compulsary subjects and anyone from Maths/Bio-technology/Biology</li>
            <li>Candidate should score minimim 45% marks in 12th class(40% for SC/ST/OBC other than  creamy layer )
            </li>
            </ul>
        </li>
    </ol>
